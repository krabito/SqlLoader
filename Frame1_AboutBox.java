...
public class Frame1_AboutBox extends JDialog implements ActionListener {
  ...
  String product = "SqlLoader";
  String version = "0.1a";
  String copyright = "Copyright (c) 2000";
  String comments = "Database Loader";
  ...
  private void jbInit() throws Exception  {
    ...
    String aboutGraphic = "mad_hacker.gif";
    File gifFile = new File(aboutGraphic);
    //System.out.println("Gif length: " +    gifFile.length());
    //System.out.println("File: " + gifFile.getAbsoluteFile());
    imageIcon = new ImageIcon(SqlLoader.class.getResource(aboutGraphic));
    this.setTitle("About");
    setResizable(false);
